...
<body>
    <div id="app">
      <nav style="background:transparent;" class="navbar navbar-expand-md navbar-light navbar-laravel">
          <div class="container">
            <img alt="" src="{{asset('img/logo.png')}}" style="height:50px; width:50px;">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                          ...
                          @can ('grupos.index')
                          <li class="nav-item">
                            <a style="color:white;" class="nav-link" href="{{ route('grupos.index') }}">Grupos</a>
                          </li>
                          @endcan
                          @can ('alumnos.index')
                          <li class="nav-item">
                            <a style="color:white;" class="nav-link" href="{{ route('alumnos.index') }}">Alumnos</a>
                          </li>
                          @endcan
                          @can ('roles.index')
                          <li class="nav-item">
