      ...
      <div class="row">
          ...
          <br>
              <div class="card">
                ...
                @can ('grupos.index')
                  <?php
                    $idUser=DB::table('datos_docentes')->where('user_id',Auth::user()->id)->pluck('id');
                  ?>
                  @if(count($idUser)>0)
                    <div class="card-body">
                                ...
                                <tr>
                                  <th scope="row">
                                    ...
                                    <input type="hidden" name='user_id[]' value="{{$alumno->user_id}}">
                                      ...
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad1}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad2}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad3}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad4}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad5}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad6}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad7}}" tabindex="8" disabled>
                                      </th>
                                      <th>
                                        <input min="0" max="100"  class='form-control form-control-sm' type="number"
                                        value="{{$alumno->unidad8}}" tabindex="8" disabled>
                                    ...
                                    <label for="  ">{{$alumno->$nivelac}}</label>
                                      ...
                                      <th >
                                          ...
                                          {!! Form::open(['route' => ['grupos.removeralumno', $grupo->id],
                                            'method'=>'PUT']) !!}
                                              <input type="hidden" name='userId' id='userId' value="{{$alumno->id}}">
